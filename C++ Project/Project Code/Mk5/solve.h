...
float* Solve_LU_x_B(float * uppertriangle_ptr,float * lowertriangle_ptr,float * B, int n)
{
        ...
        /**
                ...
                To find x, 
                1. we first use back-substitution** (from top to bottom) from L and B to find Y such that U.x = Y
                2. we then use forward-substitution** (from bottom to top) from U and Y to find x.
