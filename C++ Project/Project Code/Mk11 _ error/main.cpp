        ...
        **/
        ...
        {       
                ...
                if(is_int)
                        { 
                                if(i==0)
                                        {var1 = Variable<int>("a",floor_val);}

                                if(i==1)
                                        {var2 = Variable<int>("b",floor_val);}

                                if(i==2)
                                        {var3 = Variable<int>("c",floor_val);}

                                if(i==3)
                                        {var4 = Variable<int>("d",floor_val);}
                        }
                else
                        { 
                                if(i==0)
                                        {var1 = Variable<float>("a",soln_val);}

                                if(i==1)
                                        {var2 = Variable<float>("b",soln_val);}

                                if(i==2)
                                        {var3 = Variable<float>("c",soln_val);}

                                if(i==3)
                                        {var4 = Variable<float>("d",soln_val);}
                        }
                

                
                //      switch-case has not been used since it gives an error late regarding object not declared in scope.
